# VoiceDock 詳細仕様書 v5.31

**DJI Mic 3 × ローカル文字起こし × ローカルLLM × Obsidian**

| 項目 | 内容 |
|---|---|
| 文書版 | **v5.31（README を clone から通し、件数を固定する）** |
| 前身文書 | v5.30 / v5.29 / v5.28 / v5.27 / v5.26 / v5.25 / v5.24 / v5.23 / v5.22 / v5.21 / v5.20 / v5.19 / v5.18 / v5.17 / v5.16 / v5.15 / v5.14 / v5.13 / v5.12 / v5.11 / v5.10 / v5.9 / v5.8 / v5.7 / v5.6 / v5.5 / v5.4 / v5.3 / v5.2 / v5.1 / v5.0 / v4.6 / v4.5 / v4.4 / v4.3 / v4.2 / v4.1 / v4.0 / v3.4 / v3.3 / v3.2 / v3.1 / v3.0（git 履歴）、`docs/archive/VoiceDock_Docker_Implementation_Spec_v2.0.md`（方針書） |
| 作成日 | 2026-09-11 |
| 改訂日 | 2026-09-14 |
...
- `status == OPEN` でないセッションへも `session_key` は**そのまま割り当てる。セッションの状態はここでは変えない**（v5.7→v5.8 の変更 T-1）。確定済みのセッションを `MERGING` へ戻すのは、**その Part が `RAW_SAVED` に達した時点**である（§9.3 の `SAVED` / `COMPLETED` 行。`session.allow_reopen`）
