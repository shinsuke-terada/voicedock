# VoiceDock 詳細仕様書 v5.44

**DJI Mic 3 × ローカル文字起こし × ローカルLLM × Obsidian**

| 項目 | 内容 |
|---|---|
| 文書版 | **v5.44（cleanup --backlog / --resolve-absent を足す）** |
...
> 瞬間に結果が迷子になる。**`status` は `DELETED` か `SOURCE_IDENTITY_MISMATCH` の
