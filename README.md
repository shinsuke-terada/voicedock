...
| 7 削除 | **コードは揃っている**（`cleaner.py` と `voicedock-reaper`、削除禁止テスト ND-01〜31）が、**有効化していない。**§21.2 は ND-01〜ND-31 と E2E-01〜E2E-12 の全件 PASS を前提にしており、**残るのは E2E-06（運用の中で確認。#125）と E2E-10 / E2E-11（Phase 7 そのもの）である** |
| 8 運用 | 本章のとおり |
