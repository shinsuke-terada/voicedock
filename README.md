...
| 1〜6 取り込み・変換・文字起こし・ノート生成 | 実装済み。**E2E-01〜E2E-05 / E2E-07〜E2E-09 / E2E-12 を実機で PASS**（[docs/E2E.md](docs/E2E.md)） |
| 7 削除 | **コードは揃っている**（`cleaner.py` と `voicedock-reaper`、削除禁止テスト ND-01〜32。**ND-10〜17 は v5.37 で廃止し欠番**）が、**有効化していない。**§21.2 は ND-01〜ND-32 と E2E-01〜E2E-12 の全件 PASS を前提にしており、**残るのは E2E-06（運用の中で確認。#125）と E2E-10 / E2E-11（Phase 7 そのもの）である** |
| 8 運用 | 本章のとおり |
